...
const handleIntent = async (context, input, sender, baseURL) => {
  ...
  switch (intent) {
    case "greeting":
      ...
      answer =
        "Hello there, I am CMPE 280. Would you like to see the items available in this store?";
      return answer;
    ...
    case "refusing":
      if (user.fields.State === "greeting") {
        answer =
          "Great. Once you are ready to see the products send the phrase 'show products' ";
        return answer;
      } else if (user.fields.State === "addToCart") {
        answer =
          "Great. Once you are ready to checkout send the word 'checkout' ";
        return answer;
      } else {
        return answer;
      }
    ...
    case "addToCart":
      ...
      answer = itemAddedToCart
        ? "Item successfully added to cart. Would you like to see cart?"
        : "Failed to add the item to checkout";
      return answer;
    ...
    default:
      answer =
        "I am sorry but I didn't understand what you meant. Can you please rephrase?";
      return answer;
  }
};
